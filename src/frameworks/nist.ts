...
export const NIST_CONTROLS: NistControl[] = [
  ...
  { id: 'MAP 2.1', name: 'Threat identification', scannerIds: ['prompt-injection'] },
  ...
  { id: 'MEASURE 2.3', name: 'AI system testing', scannerIds: ['api-keys', 'prompt-injection', 'output-handling', 'pii-exposure', 'system-prompts', 'tool-permissions', 'rate-limiting', 'audit-logging', 'model-versions', 'env-security', 'log-analyzer'] },
